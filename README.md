...
Objectives
- Calculate periodic loan payments (EMI)
- Analyse principal and interest components
- Prepare a loan amortization schedule
- Track outstanding loan balance over the loan tenure
- Understand the impact of loan amount, interest rate, and tenure on repayment
- Apply financial modelling concepts to a practical finance problem

Financial Concepts that demonstrates practical application of:
- Time Value of Money
- Compound Interest
- Loan Amortization
- Present Value
...
Building an interactive financial model
